<template>
  <div style="margin-right: auto; margin-left: auto;">
    ...
    <div @click="d()" style="text-align: center; display: flex; position: fixed; bottom: 1rem; left: 50%; transform: translateX(-50%);">
      <v-pagination
        v-model="page"
        color="secondary"
        :length="length"
        :total-visible="7"
      ></v-pagination>
      <v-btn color="info" @click="page=length; d()">Last</v-btn>
    </div>
  </div>
